...
{
    public class M23ReliabilityMonitoringController : Controller
    {
            ...
            , string classDefnFileName)
        {
            ...
            return View("~/Views/Maintenance/Maintenance/ReportGeneratorViews/23ReliabilityMonitoring.cshtml");
        }
    }
}
