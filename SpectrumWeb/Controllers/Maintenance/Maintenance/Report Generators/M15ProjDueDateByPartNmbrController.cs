...
{
    public class M15ProjDueDateByPartNmbrController : Controller
    {
        public IActionResult ProjDueDateByPartNmbrGenerator(
            ...
            , string classDefnFileName)
        {
            ...
            return View("~/Views/Maintenance/Maintenance/ReportGeneratorViews/M15ProjDueByPartNmbr.cshtml");
        }
    }
}
